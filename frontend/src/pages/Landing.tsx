      ...
      <div className=" flex-auto">
        <div className="my-4">
          <div className="flex justify-center">
            <img src={landing1} alt="" className="w-[420px] h-[320px]  z-10 rounded-lg" />
            {/* <div className=" bg-orange-500 w-[100%] absolute bottom-0 h-[40%] ml-8 "></div> */}
          </div>

          <div className="my-10">
            <p className=" text-center text-primary">Get your experience</p>
      ...
      <div className="flex flex-col">
        ...
        <div className="my-3">
          <div className="text-center my-4">
            <p className="text-2xl text-primary font-bold">1M++</p>
            <p>Helping People Find the best place for healing</p>
          </div>
          <div className="text-center my-4">
            <p className="text-2xl text-primary font-bold">20 Years</p>
            <p>Years of experience on camping rent</p>
          </div>
          <div className="text-center my-4">
            <p className="text-2xl text-primary font-bold">100++</p>
          ...
          <div className="relative ">
            ...
            <div className="  absolute bottom-0 mt-4 py-4 px-14 text-center  my-auto w-full ">
              <div className="bg-orange-500 h-[60px] p-1">
                <p className="pt-1 font-bold">Hidden Gems</p>
      ...
      <div>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <img src={where1} alt="" className=" rounded-lg" />
            <div className="my-4">
              <h2 className="mb-2 font-bold text-xl">with campfire</h2>
              <p className="text-sm">
            ...
            <Button variant="outline" className=" flex justify-center my-auto">
